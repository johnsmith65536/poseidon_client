...
public partial class Server {
  public interface ISync {
    ...
    FetchOfflineMessageResp FetchOfflineMessage(FetchOfflineMessageReq req);
    ...
    MessageDeliveredResp MessageDelivered(MessageDeliveredReq req);
  }
  ...
  public interface Iface : ISync {
    ...
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_FetchOfflineMessage(AsyncCallback callback, object state, FetchOfflineMessageReq req);
    FetchOfflineMessageResp End_FetchOfflineMessage(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    ...
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_MessageDelivered(AsyncCallback callback, object state, MessageDeliveredReq req);
    MessageDeliveredResp End_MessageDelivered(IAsyncResult asyncResult);
    #endif
  }
  ...
  public class Client : IDisposable, Iface {
    ...
    public IAsyncResult Begin_FetchOfflineMessage(AsyncCallback callback, object state, FetchOfflineMessageReq req)
    {
      return send_FetchOfflineMessage(callback, state, req);
    }

    public FetchOfflineMessageResp End_FetchOfflineMessage(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
      return recv_FetchOfflineMessage();
    }

    #endif

    public FetchOfflineMessageResp FetchOfflineMessage(FetchOfflineMessageReq req)
    {
      #if SILVERLIGHT
      var asyncResult = Begin_FetchOfflineMessage(null, null, req);
      return End_FetchOfflineMessage(asyncResult);

      #else
      send_FetchOfflineMessage(req);
      return recv_FetchOfflineMessage();

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_FetchOfflineMessage(AsyncCallback callback, object state, FetchOfflineMessageReq req)
    {
      oprot_.WriteMessageBegin(new TMessage("FetchOfflineMessage", TMessageType.Call, seqid_));
      FetchOfflineMessage_args args = new FetchOfflineMessage_args();
      args.Req = req;
      args.Write(oprot_);
      oprot_.WriteMessageEnd();
      return oprot_.Transport.BeginFlush(callback, state);
    ...
    public void send_FetchOfflineMessage(FetchOfflineMessageReq req)
    {
      oprot_.WriteMessageBegin(new TMessage("FetchOfflineMessage", TMessageType.Call, seqid_));
      FetchOfflineMessage_args args = new FetchOfflineMessage_args();
      args.Req = req;
    ...
    public FetchOfflineMessageResp recv_FetchOfflineMessage()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
      ...
      FetchOfflineMessage_result result = new FetchOfflineMessage_result();
      result.Read(iprot_);
      iprot_.ReadMessageEnd();
      if (result.__isset.success) {
        return result.Success;
      }
      throw new TApplicationException(TApplicationException.ExceptionType.MissingResult, "FetchOfflineMessage failed: unknown result");
    }
    ...
    public IAsyncResult Begin_MessageDelivered(AsyncCallback callback, object state, MessageDeliveredReq req)
    {
      return send_MessageDelivered(callback, state, req);
    }

    public MessageDeliveredResp End_MessageDelivered(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
      return recv_MessageDelivered();
    }

    #endif

    public MessageDeliveredResp MessageDelivered(MessageDeliveredReq req)
    {
      #if SILVERLIGHT
      var asyncResult = Begin_MessageDelivered(null, null, req);
      return End_MessageDelivered(asyncResult);

      #else
      send_MessageDelivered(req);
      return recv_MessageDelivered();

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_MessageDelivered(AsyncCallback callback, object state, MessageDeliveredReq req)
    {
      oprot_.WriteMessageBegin(new TMessage("MessageDelivered", TMessageType.Call, seqid_));
      MessageDelivered_args args = new MessageDelivered_args();
      args.Req = req;
      args.Write(oprot_);
      oprot_.WriteMessageEnd();
      return oprot_.Transport.BeginFlush(callback, state);
    ...
    public void send_MessageDelivered(MessageDeliveredReq req)
    {
      oprot_.WriteMessageBegin(new TMessage("MessageDelivered", TMessageType.Call, seqid_));
      MessageDelivered_args args = new MessageDelivered_args();
      args.Req = req;
    ...
    public MessageDeliveredResp recv_MessageDelivered()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
      ...
      MessageDelivered_result result = new MessageDelivered_result();
      result.Read(iprot_);
      iprot_.ReadMessageEnd();
      if (result.__isset.success) {
        return result.Success;
      }
      throw new TApplicationException(TApplicationException.ExceptionType.MissingResult, "MessageDelivered failed: unknown result");
    }
  ...
  public class Processor : TProcessor {
    public Processor(ISync iface)
    {
      ...
      processMap_["FetchOfflineMessage"] = FetchOfflineMessage_Process;
      ...
      processMap_["MessageDelivered"] = MessageDelivered_Process;
    }
    ...
    public void FetchOfflineMessage_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      FetchOfflineMessage_args args = new FetchOfflineMessage_args();
      args.Read(iprot);
      iprot.ReadMessageEnd();
      ...
      try
      {
        result.Success = iface_.FetchOfflineMessage(args.Req);
        oprot.WriteMessageBegin(new TMessage("FetchOfflineMessage", TMessageType.Reply, seqid)); 
        result.Write(oprot);
      }
      catch (TTransportException)
      {
      ...
      catch (Exception ex)
      {
        ...
        Console.Error.WriteLine(ex.ToString());
        TApplicationException x = new TApplicationException      (TApplicationException.ExceptionType.InternalError," Internal error.");
        oprot.WriteMessageBegin(new TMessage("FetchOfflineMessage", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
    ...
    public void MessageDelivered_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      MessageDelivered_args args = new MessageDelivered_args();
      args.Read(iprot);
      iprot.ReadMessageEnd();
      ...
      try
      {
        result.Success = iface_.MessageDelivered(args.Req);
        oprot.WriteMessageBegin(new TMessage("MessageDelivered", TMessageType.Reply, seqid)); 
        result.Write(oprot);
      }
      catch (TTransportException)
      {
      ...
      catch (Exception ex)
      {
        ...
        Console.Error.WriteLine(ex.ToString());
        TApplicationException x = new TApplicationException      (TApplicationException.ExceptionType.InternalError," Internal error.");
        oprot.WriteMessageBegin(new TMessage("MessageDelivered", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
  ...
  [Serializable]
  #endif
  public partial class FetchOfflineMessage_args : TBase
  {
    private FetchOfflineMessageReq _req;

    public FetchOfflineMessageReq Req
    {
      get
      {
        return _req;
    ...
    public FetchOfflineMessage_args() {
    }
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              if (field.Type == TType.Struct) {
                Req = new FetchOfflineMessageReq();
                Req.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("FetchOfflineMessage_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("FetchOfflineMessage_args(");
      bool __first = true;
      if (Req != null && __isset.req) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
  ...
  [Serializable]
  #endif
  public partial class FetchOfflineMessage_result : TBase
  {
    private FetchOfflineMessageResp _success;

    public FetchOfflineMessageResp Success
    {
      get
      {
        return _success;
    ...
    public FetchOfflineMessage_result() {
    }
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 0:
              if (field.Type == TType.Struct) {
                Success = new FetchOfflineMessageResp();
                Success.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("FetchOfflineMessage_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("FetchOfflineMessage_result(");
      bool __first = true;
      if (Success != null && __isset.success) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
  ...
  [Serializable]
  #endif
  public partial class MessageDelivered_args : TBase
  {
    private MessageDeliveredReq _req;

    public MessageDeliveredReq Req
    {
      get
      {
        return _req;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("MessageDelivered_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("MessageDelivered_args(");
      bool __first = true;
      if (Req != null && __isset.req) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
  ...
  [Serializable]
  #endif
  public partial class MessageDelivered_result : TBase
  {
    private MessageDeliveredResp _success;

    public MessageDeliveredResp Success
    {
      get
      {
        return _success;
    ...
    public MessageDelivered_result() {
    }
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 0:
              if (field.Type == TType.Struct) {
                Success = new MessageDeliveredResp();
                Success.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("MessageDelivered_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("MessageDelivered_result(");
      bool __first = true;
      if (Success != null && __isset.success) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
